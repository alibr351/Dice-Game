...
/* Hook up a click event listener to the Roll Dice Button. */
 rollBtn.addEventListener("click", function() {
    ...
    if (player1Score >= 20) {
        message.innerHTML = `<img class="animation" src="images/giphy.gif"><b> <p class="declare">Player 1 Won 🥳</p>`
        showResetButton()
    }  else if (player2Score >= 20) {
        message.innerHTML = `<img class="animation" src="images/giphy.gif"><b> <p class="declare">Player 2 Won 🥳</p> `
        showResetButton()
    }
